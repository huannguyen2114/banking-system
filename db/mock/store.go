...
// Source: github.com/huannguyen2114/go-toy-project/db/sqlc (interfaces: Store)
//
...
// DeleteEntrg mocks base method.
func (m *MockStore) DeleteEntrg(arg0 context.Context, arg1 int64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteEntrg", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteEntrg indicates an expected call of DeleteEntrg.
func (mr *MockStoreMockRecorder) DeleteEntrg(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteEntrg", reflect.TypeOf((*MockStore)(nil).DeleteEntrg), arg0, arg1)
}
